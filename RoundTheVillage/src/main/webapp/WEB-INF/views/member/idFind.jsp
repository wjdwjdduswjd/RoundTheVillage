...
<body>
	<div class="container">
		...
		<form action="idFindComplete" method="post">
			<!-- 이름, 이메일 입력 -->
			<div class="input-text">
				<div class="input-area in-area">
					<label class="text">이름</label> <input class="b" type="text" name="memberName" id="memberName">
				</div>


				<div class="input-area ">
					<label class="text">이메일 주소</label> <input class="b" type="text" name="memberEmail" id="memberEmail" placeholder="가입했을 때 인증했던 이메일을 입력해주세요.">
					<button type="button" id="idFind-email" class="idFind-email">인증번호 받기</button>
				</div>

				<!-- 이메일인증번호 입력부분 -->
				<div class="input-area">
					<label class="addr text"></label> <input class="b" type="text" name="idFind-crtfd-num" id="idFind-crtfd-num" placeholder="인증번호를 입력해주세요.">
				</div>

				<!-- 완료 버튼 -->
				<div class="input-area">
					<label class="addr text"></label>
					<button class="b b-a" type="submit" name="idFind-crtfd" id="idFind-crtfd">완료</button>
				</div>
