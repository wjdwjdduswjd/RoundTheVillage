...
<body>
	...
	<div class="container">
		...
		<div class="row p-3 bg-light rounded mb-7">
			...
			<div class="offset-md-1 col-md-10 p-1 mb-1" id="title">
			<br>
<br>
				<strong>썸네일</strong>
				<div class="boardImg ml-5" id="titleImgArea">
					<img src="${contextPath}${thumb.filePath}/${thumb.fileName}" width="275" height="400">
				</div>
			</div>
...
<br><br>
			...
			<div class="offset-md-1 col-md-10 p-1 mb-3">${shop.thumbInfo}</div>
		...
		<div class="text-right">
			<a href="../regiCon/${shop.shopNo}" class="btn btn-around <c:if test="${shop.shopRegiFL == 'Y'.charAt(0)}">disabled</c:if>">승인</a> <a href="${returnListURL}" class="btn btn-around-2">목록으로</a>
		</div>
